...
def download(context: UFDLServerContext, pk: int,
    ...
    return core_download(context, IMAGE_CLASSIFICATION_DATASETS_URL,
                         pk,
                         filetype,
...
def get_all_metadata(context: UFDLServerContext, pk: int) -> str:
    return core_get_all_metadata(context, IMAGE_CLASSIFICATION_DATASETS_URL, pk)
...
def merge(context: UFDLServerContext, pk: int, source_pk: int, delete: bool, hard: OptionallyPresent[bool] = Absent) -> RawJSONObject:
    return core_merge(context, IMAGE_CLASSIFICATION_DATASETS_URL, pk, source_pk, delete, hard)
